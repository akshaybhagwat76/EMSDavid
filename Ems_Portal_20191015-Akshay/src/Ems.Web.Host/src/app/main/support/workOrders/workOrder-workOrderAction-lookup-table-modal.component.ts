...
@Component({
    selector: 'workOrderWorkOrderActionLookupTableModal',
    styleUrls: ['./workOrder-workOrderAction-lookup-table-modal.component.less'],
    encapsulation: ViewEncapsulation.None,
    templateUrl: './workOrder-workOrderAction-lookup-table-modal.component.html'
})
export class WorkOrderWorkOrderActionLookupTableModalComponent extends AppComponentBase {
